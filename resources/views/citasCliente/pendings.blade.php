...
<div class="row">
	<div class="col-md-9 col-sm-12 mt-2">
		<div class="card">
			...
			<p class="font-weight-bold">@lang('clients.pending_appointment')</p>
			<a href="{{route('citas_index')}}" class="btn btn-primary"><i class="far fa-calendar-alt"></i> @lang('clients.appointments_history')</a>
		</div>
			<div class="card-body">
				@if(count($data)>0)
